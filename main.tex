...
{}
{\jobtitle{\href{https://arxiv.org/abs/2411.14467}{Towards Scalable Insect Monitoring: Ultra-Lightweight CNNs as On-Device Triggers for Insect Camera Traps}} }
  \entry
    {2022}
    {Ecological Informatics Journal}
    {}
    {\jobtitle{\href{https://doi.org/10.1016/j.ecoinf.2022.101657}{Motion vectors and deep neural networks for video camera traps}}}
    \end{entrylist}
  \vspace{-0.2cm}
...
{\scalebox{.8}[1.0]{September 2023 -- Present}}
  ...
  My research is focused on the application of AI technologies to biodiversity monitoring. I am particularly interested in: how large-scale self-supervised foundation models can be leveraged by practitioners for rapid ecological assessment, how explainable-AI techniques can be explored to build trust in learned representations from fine-grained and long-tailed training data, and how AI can operate at the edge in conjunction with growing specialised conservation hardware solutions. I am concurrently working as a Teaching Assistant, responsible for delivering and grading undergraduate laboratory sessions.
  }
%\entry
